...
function Singup(props) {
  ...
  return (
    ...
    <br/>
            <button class="loginbutton" onClick={()=>{signinuser(formData)}}>Signup</button>
        <p className="loginpara">Already have account,<p onClick={() => navigate('/login')}>Go to login page.</p></p>
